...
# DADOS DO CONTRATO
department = models.ForeignKey('Setor', on_delete=models.PROTECT, verbose_name='Setor', related_name='funcionarios_setor') 
job_title = models.ForeignKey('Cargo', on_delete=models.PROTECT, verbose_name='Cargo', related_name='funcionarios_cargo') 
